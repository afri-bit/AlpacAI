...
while (cap.isOpened()):
    ...
    if ret:
        ...
        print(
            f'Drowsiness Score: {drowsiness_score}   Distraction Score: {distractionScore}   Distraction Score Prev: {distractionScorePrev}    keepPrev: {keepPrev}')
